...
/////////////////////////////////////////////////////////////////////////////////////////
//   НОВАЯ ПАНЕЛЬ КОМПЛЕКТОВ ДЛЯ ГАРАЖА (с индивидуальным сбросом и статусами X/Y)
/////////////////////////////////////////////////////////////////////////////////////////
...
function tryRenderKitPanel() {
    if (location.pathname === "/automobile/ride/") {
        // Ждём появления блока гаража
        const garageReady = setInterval(() => {
            const garageForm = document.querySelector("#garage .garageform");
            if (garageForm) {
                renderKitPanel();
